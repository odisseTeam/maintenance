...
class CreateMaintenanceJobSlaRefTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('maintenance_job_sla_ref', function (Blueprint $table) {
            ...
            $table->integer('id_maintenance_job_priority_ref')->index('fk_sla_maintenance_job_priority1_idx');
            $table->integer('id_client')->nullable();
            $table->string('maximum_expected_seen_minutes')->nullable();
            $table->string('expected_target_minutes')->nullable();
            ...
            $table->foreign('id_maintenance_job_priority_ref', 'fk_sla_maintenance_job_priority1_idx')->references('id_maintenance_job_priority_ref')->on('maintenance_job_priority_ref')->onUpdate('NO ACTION')->onDelete('NO ACTION');
