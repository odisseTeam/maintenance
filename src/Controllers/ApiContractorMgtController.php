...
class ApiContractorMgtController extends Controller{
    ...
    public function changeContractorLoginSetting(Request $request)
    {
    ...
    public function getContractorSkillsInfo(Request $request){
