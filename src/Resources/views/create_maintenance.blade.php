...
@endif
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <form action="/maintenance/new/save" method="post">
                            @csrf
                            <div class="box-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 col-xs-12 col-md-12">
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <div class="form-group row">
                                            <label class="col-xs-2 col-sm-2 col-md-2 control-label text-right">{{trans('maintenance::maintenance.description')}}:</label>
                                            <div class="col-xs-10 col-sm-10 col-md-10">
                                               <div class="input-group col-xs-10 col-sm-10 col-md-10">

                                                  <textarea class="form-control" rows="4" name="description" id="description" column="40" ></textarea>
                                               </div>
                                         ...
                                         <!-- datetime -->
                                         <div class="form-group row">
                                            <label class="col-xs-2 col-sm-2 col-md-2 control-label text-right">{{trans('maintenance::maintenance.date_time')}}:</label>
                                            <div class="col-xs-5 col-sm-5 col-md-5">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa-solid fa-calendar"
                                                        ...
                                                        placeholder="{{trans('maintenance::maintenance.date_time')}}" autocomplete="off"
                                                        value="@if (isset($maintenance)) {{ $credit_nomaintenancete->maintenance_date_time }} @elseif (old('maintenance_date')) {{ old('maintenance_date') }} @endif"
                                        ...
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            <label class="col-xs-2 col-sm-2 col-md-2 control-label text-right">{{trans('maintenance::maintenance.resident_reporter')}}:</label>
                                            <div class="col-sm-5 col-md-5 col-lg-5">
        ...
        <div class="modal fade" id="attachFileModal" tabindex="-1" role="dialog" aria-labelledby="attachFileModalLabel"
            ...
            <div class="modal-dialog modal-lg" style="max-width: 60%;">
                ...
                <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="attachFileModalLabel">{{trans('maintenance::maintenance.attach_file')}}</h4>
                        </div>
                         <div class="box">
                        <div class="box-header">
                           ...
                           <form id="attach_file_form" method="post" enctype="multipart/form-data" novalidate
                              ...
                              @csrf
                                ...
                                <div class="modal-body">
                                        ...
                                        <div class="alert alert-success alert-dismissible" id="suc_msg_box" style="display: none">
                                    ...
                                    <!-- file -->
                                        <div class="row form-group col-sm-6 col-md-6 col-lg-6" >
                                            ...
                                            <div>
                                                <input type="file" id="file" name="file" class="col-sm-8 col-md-8 col-lg-8" style="margin-top:10px;">
                                    ...
                                    <!-- description -->
                                        <div class="row form-group col-sm-6 col-md-6 col-lg-6" >
                                            <label class="control-label col-sm-5 col-md-5 col-lg-5">{{trans('maintenance::maintenance.description')}}:</label>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary"
                                        id="final_add_room">{{trans('maintenance::maintenance.save')}}</button>
                                </div>
                                </form>
    ...
    <!-- Modal -->
        <div class="modal fade" id="addParentJobModal" tabindex="-1" role="dialog" aria-labelledby="addParentJobModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg" style="max-width: 60%;">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="close" data-dismiss="modal"><span
                                aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                        <h4 class="modal-title" id="addParentJobModalLabel">{{trans('maintenance::maintenance.add_parent_job')}}</h4>
                    </div>
                    <div class="box">
                        <div class="box-header">
                    ...
                    @csrf
                    <div class="modal-body">
                            <div class="alert alert-danger alert-dismissible" id="err_msg_box_parent_job" style="display: none">
                                <div id="ajx_err_msg_parent_job"></div>
                            </div>
                            <div class="alert alert-success alert-dismissible" id="suc_msg_box_parent_job" style="display: none">
