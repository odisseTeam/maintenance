...
@endif
        ...
        <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="{{ session('active_tab') == 'maintenance_documents' ? 'active' : '' }}">
                        <a id="maintenance_documents_tab" href="#maintenance_documents" data-toggle="tab">{{ __('maintenance::maintenance.maintenance_documents') }}</a>
                    </li>
                </ul>
                @endif
                                    ...
                                    @csrf
                                            <div class="box-body">
                                              ...
                                              <input type="hidden" id="id_maintenance" name="id_maintenance" value="{{$maintenance->id_maintenance_job}}" >
                                                ...
                                                <div class="form-group row col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-top:15px;">
                                                            ...
                                                            <div class="col-sm-5 col-md-5 col-lg-5">
                                                                ...
                                                                <select name="priority" id="priority" class="form-control select ">
                                                                    ...
                                                                    <option value="{{ $priority->id_maintenance_job_priority_ref }}"
                                                                        @if(($priority->id_maintenance_job_priority_ref == $maintenance->id_maintenance_job_priority )||(old('priority') == $maintenance->id_maintenance_job_priority)) {{ 'selected' }} @endif>
             ...
             <div class="{{ (null == session('active_tab') or session('active_tab') == 'maintenance_documents') ? 'active' : '' }} tab-pane" id="maintenance_documents">
                <div class="box box-primary">
                            ...
                            <table id="maintenance_documents_table" class="table table-bordered table-hover dataTable text-center" style="width:100%">
                                            <thead>
                                            <tr>
                                                <th>#</th>
    ...
    <div class="modal fade" id="deleteMaintenanceDocumentModal" tabindex="-1" role="dialog" aria-labelledby="deleteTemplateModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">

                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">{{__('general.close')}}</span></button>

                        <h4 class="modal-title" id="deleteMaintenanceDocumentModallabel">{{__('maintenance::maintenance.delete_maintenance_document_modal')}}</h4>

                    </div>
                    <div class="form-horizontal" id="note_mgt_form" novalidate="novalidate">

                        <div class="alert alert-danger alert-dismissible" id="delete_maintenance_document_err_msg_box" style="display: none;">
                            <div id="delete_maintenance_document_ajx_err_msg"></div>
                        </div>
                        <div class="alert alert-success alert-dismissible" id="delete_maintenance_document_success_msg_box" style="display: none;">
                        ...
                        <div class="modal-footer">
                            <button type="button" id="close_btn" class="btn btn-warning" data-dismiss="modal">{{__('general.close')}}</button>
                            <button type="button" class="btn btn-danger" id="btn_operate_delete">{{__('general.yes')}}</button>
