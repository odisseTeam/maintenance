...
@section('content')
                                ...
                                <div class="col-xs-12">
                                    <div class="card box box-primary">
                                        ...
                                        <div class="card-body box-body " >
                                            ...
                                            <div><a style="float:right;" href="/maintenance/contractor"><button type="button"  style="float: right; margin: 10px 20px; min-width:135px;" id="create_contractor_btn" class="btn btn-primary" >{{trans('maintenance::contractor.create_new_contractor')}}</button></a></div>
    ...
    <!-- Modal -->
    <div class="modal" id="deleteContractorModal" tabindex="-1" role="dialog" aria-labelledby="deleteContractorModalLabel" aria-hidden="true">
    ...
    <!-- Modal -->
    <div class="modal" id="showLoginSettingsModal" tabindex="-1" role="dialog" aria-labelledby="showLoginSettingsModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" style="max-width: 60%;">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Modal -->
    <div class="modal" id="skillModal" tabindex="-1" role="dialog" aria-labelledby="skillModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" style="max-width: 60%;">
            <div class="modal-content">
                <div class="modal-header">
 ...
 <!-- Modal -->
    <div class="modal" id="contractorAttachmentModal" tabindex="-1" role="dialog" aria-labelledby="contractorAttachmentModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" style="max-width: 80%; width: 80%">
            <div class="modal-content">
                <div class="modal-header">
