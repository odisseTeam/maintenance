...
@section('content')
    ...
    <section class="content">
        ...
        <div class="nav-tabs-custom">
                ...
                <ul class="nav nav-tabs">
                    @if(! isset($contractor))
                    <li class="nav-item">
                            <a class="nav-link {{ (null == session('active_tab') or session('active_tab') == 'contractorDetail') ? 'active' : '' }}" id="contractorDetail_tab" href="#contractorDetail"
                    ...
                    @else
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ session('active_tab') == 'contractor_document' ? 'active' : '' }}" id="contractor_document_tab" href="#contractor_document"
                ...
                <div class="tab-content ">
                        <div class="{{ (null == session('active_tab') or session('active_tab') == 'maintenanceDetail') ? 'active' : '' }} tab-pane " id="contractorDetail">
                            <div class="card card-primary box box-primary">
                                <div class="card-header box-header">
                                </div>

                                    <form action="@if(! isset($contractor)){{'/maintenance/contractor'}}@else{{'/maintenance/contractor/'.$contractor->id_contractor}}@endif" method="post"  enctype="multipart/form-data" >
                                        @csrf
                                        <div class="card-body box-body">
                                            ...
                                            <!-- Note-->
                                            <div class="form-group row">
                                                <label class="col-xs-2 col-sm-2 col-md-2 control-label text-right">{{trans('maintenance::contractor.note')}}:</label>
                                                <div class="col-xs-10 col-sm-10 col-md-10">
                                                <div class="input-group col-xs-10 col-sm-10 col-md-10">

                                                    <textarea class="form-control" rows="4" name="note" id="note" column="40" >@if(old('note')){{old('note')}}@elseif(null==old('_token') && isset($contractor) ){{strip_tags($contractor->note)}}@endif</textarea>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <input type="file" id="contractor_file" name="contractor_files[]" class="" multiple style="margin-top:10px;">
                                                </div>
                                        ...
                                        <div class="card-footer box-footer text-right">
  ...
  <!-- delete contractor document Modal -->
    <div class="modal" id="deleteContractorDocumentModal" tabindex="-1" role="dialog"
