...
<style>
    .nav-tabs-custom > .nav-tabs > .nav-item > a.nav-link, .nav-tabs-custom > .nav-tabs > .nav-item > a:hover, .nav-tabs-custom > .nav-tabs > .nav-item > a:focus {
    color: #555;
    cursor: default;
...
@section('content')
    ...
    <section class="content-header">
        <h1>
            {{__('maintenance::maintenance.maintenance_detaill')}}
        </h1>
    </section>
        ...
        <div class="nav-tabs-custom">
            @if (isset($maintenance))
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ (null == session('active_tab') or session('active_tab') == 'maintenanceDetail') ? 'active' : '' }}" id="maintenanceDetail_tab" href="#maintenanceDetail"
                            data-toggle="tab">{{ __('maintenance::maintenance.maintenance_detail') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ session('active_tab') == 'maintenance_timeline' ? 'active' : '' }}" id="maintenance_timeline_tab" href="#maintenance_timeline"
                            data-toggle="tab">{{ __('maintenance::maintenance.maintenance_timeline') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ session('active_tab') == 'maintenance_documents' ? 'active' : '' }}" id="maintenance_documents_tab" href="#maintenance_documents"
            ...
            <div class="tab-content">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group date col-xs-10 col-sm-10 col-md-10" id="datepicker2" >
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group date col-xs-10 col-sm-10 col-md-10" id="datepicker3" >
                                                            <input type="text" class="form-control"
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xs-3 col-sm-3 col-md-3 control-label text-right">{{ trans('maintenance::maintenance.staff_reporter') }}:</label>
                                                    <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">

                                                        <div class="input-group col-xs-10 col-sm-10 col-md-10">


                                                        <select name="staff_reporter" id="staff_reporter" class="form-control select">
                                                            @if (isset($staffs))
                            ...
                            <div class="card">
                                ...
                                @csrf
                                    ...
                                    <div class="card-body box-body">
                                        ...
                                        <div class="form-group row col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <label class="col-xs-4 col-sm-2 col-md-2 control-label text-right">{{ trans('maintenance::maintenance.file_description') }}:</label>
                ...
                <div class="{{ (null == session('active_tab') or session('active_tab') == 'maintenance_documents') ? 'active' : '' }} tab-pane" id="maintenance_documents">
                    <div class="card card-header box box-primary">
                        <div class="card-header box-header">
                            <h3>
    ...
    <div class="modal" id="deleteMaintenanceDocumentModal" tabindex="-1" role="dialog"
