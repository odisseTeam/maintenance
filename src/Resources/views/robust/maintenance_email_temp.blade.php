...
@section('script')
 ...
 <script>
        ...
        function handlePreviewEmailContent(){
            ...
            // document.getElementById('commencement_date_preview_p').innerhtml = $("#commencement_date").val();
            // document.getElementById('complete_date_preview_p').innerhtml = $("#complete_date").val();
            // console.log('iuty');
